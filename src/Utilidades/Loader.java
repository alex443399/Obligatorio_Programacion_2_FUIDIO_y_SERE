...
public class Loader {
    ...
    public OpenHash<Integer, Movie, OpenHashNode<Integer,Movie>> LoadMovies() throws Exception{

        int number_of_columns = 22, number_of_rows = 85854;

        OpenHash<Integer, Movie, OpenHashNode<Integer,Movie>> movie_storage = new OpenHash<Integer, Movie, OpenHashNode<Integer,Movie>>(number_of_rows);//(85854);
        ...
        while((line = br.readLine()) != null){// && i < 1000
            ...
            try {
                ...
                System.out.println("Failure loading movie: {iteracion: " + Integer.toString(i) +"title: " + Integer.toString(imdb_title_id) + "}");
            }
